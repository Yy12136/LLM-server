...
class ModelConfig:
    ...
    MODEL_PATH = os.path.expanduser("~/models/Qwen2.5-32B-Instruct")  # 用户目录下的模型路径
    
    # 备选模型选项 (可根据需要切换)
    # MODEL_NAME = "Qwen/Qwen2.5-14B-Instruct"  # 14B版本，显存需求更低
    # MODEL_NAME = "Qwen/Qwen2.5-7B-Instruct"   # 7B版本，资源需求最小
    ...
    # 日志配置 - 使用用户目录
    LOG_LEVEL = "INFO"
    LOG_FILE = os.path.expanduser("~/logs/llm_deployment.log")
...
# 创建必要的目录
os.makedirs(os.path.dirname(ModelConfig.LOG_FILE), exist_ok=True)
